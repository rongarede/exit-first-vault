...
/// @notice Deploys ExitFirstVault to Base mainnet.
///
///         Required env vars:
...
///
///         Selectors pinned below come from the Day 0 probe
///         (`probe/all-selectors.txt`) and are confirmed present in the
///         Base LI.FI Diamond. They cover Across, StargateV2, and CCTP
///         facets for cross-chain USDC exit.
contract Deploy is Script {
    ...
    /// @dev Must stay in lock-step with BaseForkTest.allowedLifiSelectors().
